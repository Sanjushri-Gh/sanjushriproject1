...
export default function Home() {
  ...
  return <main>
    <header className="header">
      ...
      <button className="donate desktop" onClick={() => setModalOpen(true)}>Donate <Heart size={15}/></button>
    </header>
    ...
    {modalOpen && <div className="modal-backdrop" role="dialog" aria-modal="true"><div className="modal"><button className="modal-close" onClick={() => setModalOpen(false)} aria-label="Close"><X/></button><span className="modal-icon"><Heart fill="currentColor" size={24}/></span><h2>Thank you for caring.</h2><p>To support a programme, email Sanjushri directly. We will share the next steps and a secure way to contribute.</p><a href="mailto:sanjushri@sanjushrifoundation.org" className="donate">Email the foundation <ArrowUpRight size={16}/></a></div></div>}
  </main>;
}
